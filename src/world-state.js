    ...
    eras: [
        {
            ...
            mines: [
                ...
                {
                    name: "A Very Dark Mine",
                    discoveryMessage: "You seriously didn't go in here before? We have flashlights, it's modern ag- oh who cares.",
                    refreshRate: 55,
                    materials: [
                        { name:"Shadowstone", capacity: "500", remaining: 500, difficulty: 4, amountHeld: 0, capacity: 15, price: 20 },
                        { name:"Guano", capacity: "1000", remaining: 1000, difficulty: 3, amountHeld: 0, capacity: 20, price: 20 },
                        { name:"Ancient Epitaphs", capacity: "300", remaining: 300, difficulty: 7, amountHeld: 0, capacity: 40, price: 20 },
                        { name:"Remains of an Edgelord", capacity: "90", remaining: 90, difficulty: 8, amountHeld: 0, capacity: 80, price: 20 },
                        { name:"Advanced Darkness", capacity: "75", remaining: 75, difficulty: 9, amountHeld: 0, capacity: 130, price: 20 }
                    ]
                }
            ],
            dungeons: [
